...
public class AssortmentImpl implements Assortment {
  ...
  private void populateWithDummyData() {
    ...
    assortmentMap.put(Long.valueOf("9780739360385"),
        new BookDetailsImpl(Long.valueOf("9780739360385"), "Harry Potter and the deathly hallows",
            "J.K.Rowling", 5450,
    ...
    assortmentMap.put(Long.valueOf("9780553382563"),
        new BookDetailsImpl(Long.valueOf("9780553382563"), "I, Robot", "Isaac Asimov", 2300,
    ...
    assortmentMap.put(Long.valueOf("9781977791122"),
        new BookDetailsImpl(Long.valueOf("9781977791122"), "White nights", "Fyodor Dostoevsky", 845,
            "Set in 1840s St. Petersburg, the short story White Nights starts with its unnamed narrator walking around the streets of the city by himself. He states that though he has lived in the city eight years, he has only acquaintances, including an old man he frequently meets on one of his walks but never talks to."));
    assortmentMap.put(Long.valueOf("9780262538473"),
        new BookDetailsImpl(Long.valueOf("9780262538473"), "The invincible", "Stanislaw Lem", 2327,
